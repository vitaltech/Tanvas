...
class WooCommerceMyAccountWidget extends WP_Widget {
    ...
    function form($instance) {
        ...
        //added by derwent
        $show_lost_pwd_link = isset( $instance['show_lost_pwd_link'] ) ? (bool) $instance['show_lost_pwd_link'] : false;
    	$show_register_link = isset( $instance['show_register_link'] ) ? (bool) $instance['show_register_link'] : false;
        $show_help_link = isset( $instance['show_help_link'] ) ? (bool) $instance['show_help_link'] : false;
    	
        ?>
    	<p>
            <label for="<?php echo $this->get_field_id('logged_out_title'); ?>">
                <?php _e('Logged out title:', 'woocommerce-my-account-widget') ?>
            </label>
    		<input 
                type="text" 
                class="widefat" 
                ...
                value="<?php 
                    if (isset ( $instance['logged_out_title'])) 
                        echo esc_attr( $instance['logged_out_title'] ); 
                    else 
                        echo __('Customer Login', 'woocommerce-my-account-widget'); 
                ?>" 
            />
        </p>
    	<p>
            <label for="<?php echo $this->get_field_id('logged_in_title'); ?>">
                <?php _e('Logged in title:', 'woocommerce-my-account-widget') ?>
            </label>
    		<input 
                type="text" 
                class="widefat" 
                id="<?php echo esc_attr( $this->get_field_id('logged_in_title') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('logged_in_title') ); ?>" 
                value="<?php 
                    if (isset ( $instance['logged_in_title'])) 
                        echo esc_attr( $instance['logged_in_title'] ); 
                    else 
                        echo __('Welcome %s', 'woocommerce-my-account-widget'); 
                ?>" 
            />
        </p>
       	<p>
            <input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('show_cartlink') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('show_cartlink') ); ?>"
                <?php checked( $show_cartlink ); ?> 
            />
    		<label for="<?php echo $this->get_field_id('show_cartlink'); ?>">
                <?php _e( 'Show link to shopping cart', 'woocommerce-my-account-widget' ); ?>
            </label><br />
    		<input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('show_items') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('show_items') ); ?>"
                <?php checked( $show_items ); ?> 
            />
    		<label for="<?php echo $this->get_field_id('show_items'); ?>">
                <?php _e( 'Show number of items in cart', 'woocommerce-my-account-widget' ); ?>
            </label><br />
            <?php if (class_exists('WPF_Uploads')): ?>
        		<input 
                    type="checkbox" 
                    class="checkbox" 
                    id="<?php echo esc_attr( $this->get_field_id('show_upload_new') ); ?>" 
                    name="<?php echo esc_attr( $this->get_field_name('show_upload_new') ); ?>"
                    <?php checked( $show_upload_new ); ?> 
                />
        		<label for="<?php echo $this->get_field_id('show_upload_new'); ?>">
                    <?php _e( 'Show number of uploads left', 'woocommerce-my-account-widget' ); ?>
                </label><br />
    		<?php elseif (function_exists('woocommerce_umf_admin_menu')): ?>
        		<input 
                    type="checkbox" 
                    class="checkbox" 
                    id="<?php echo esc_attr( $this->get_field_id('show_upload') ); ?>" 
                    name="<?php echo esc_attr( $this->get_field_name('show_upload') ); ?>"
                    <?php checked( $show_upload ); ?> 
                />
        		<label for="<?php echo $this->get_field_id('show_upload'); ?>">
                    <?php _e( 'Show number of uploads left', 'woocommerce-my-account-widget' ); ?>
                </label><br />
    		<?php endif; ?>
    		<input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('show_unpaid') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('show_unpaid') ); ?>"
                <?php checked( $show_unpaid ); ?> 
            />
    		<label for="<?php echo $this->get_field_id('show_unpaid'); ?>">
                <?php _e( 'Show number of unpaid orders', 'woocommerce-my-account-widget' ); ?>
            </label><br/>
    		<input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('show_pending') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('show_pending') ); ?>"
                <?php checked( $show_pending ); ?> 
            />
    		<label for="<?php echo $this->get_field_id('show_pending'); ?>">
                <?php _e( 'Show number of uncompleted orders', 'woocommerce-my-account-widget' ); ?>
            </label><br>
            <input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('show_logout_link') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('show_logout_link') ); ?>"
                <?php checked( $show_logout_link ); ?> 
            />
            <label for="<?php echo $this->get_field_id('show_logout_link'); ?>">
                <?php _e( 'Show logout link', 'woocommerce-my-account-widget' ); ?>
            </label><br/>
        <!-- start added by derwent -->
            <input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('show_lost_pwd_link') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('show_lost_pwd_link') ); ?>"
                <?php checked( $show_lost_pwd_link ); ?> 
            />
            <label for="<?php echo $this->get_field_id('show_lost_pwd_link'); ?>">
                <?php _e( 'Show lost password link', 'woocommerce-my-account-widget' ); ?>
            </label><br/>
    		<input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('show_register_link') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('show_register_link') ); ?>"
                <?php checked( $show_register_link ); ?> 
            />
    		<label for="<?php echo $this->get_field_id('show_register_link'); ?>">
                <?php _e( 'Show register link', 'woocommerce-my-account-widget' ); ?>
            </label><br/>
        </p>
        <p>
            <input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('show_help_link') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('show_help_link') ); ?>"
                <?php checked( $show_help_link ); ?> 
            />
            <label for="<?php echo $this->get_field_id('show_help_link'); ?>">
                <?php _e( 'Show account help link', 'woocommerce-my-account-widget' ); ?>
            </label> <br /> 
            <label for="<?php echo $this->get_field_id('help_title'); ?>">
                <?php _e('Help title:', 'woocommerce-my-account-widget') ?>
            </label>
            <input 
                type="text" 
                class="widefat" 
                id="<?php echo esc_attr( $this->get_field_id('help_title') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('help_title') ); ?>" 
                value="<?php 
                    if (isset ( $instance['help_title'])) 
                        echo esc_attr( $instance['help_title'] ); 
                    else 
                        echo __('Account Help', 'woocommerce-my-account-widget'); 
                ?>" 
            />                  
            <label for="<?php echo $this->get_field_id('help_page'); ?>">
                <?php _e('Location of account help page:', 'woocommerce-my-account-widget') ?>
            </label>
            <select name="<?php echo esc_attr( $this->get_field_name('help_page') ); ?>" class="widefat">
                <option value="">
                    <?php echo esc_attr( __( 'Select page','woocommerce-my-account-widget' ) ); ?>
                </option> 
                <?php 
                    $pages = get_pages(); 
                    foreach ( $pages as $page ) {
                        $option = '<option value="' . $page->ID . '" '.selected($instance['help_page'],$page->ID,false).'>';
            ...
            <label for="<?php echo $this->get_field_id('register_page'); ?>">
                <?php _e('Location of account register page:', 'woocommerce-my-account-widget') ?>
            </label>
            <select name="<?php echo esc_attr( $this->get_field_name('register_page') ); ?>" class="widefat">
                <option value="">
                    <?php echo esc_attr( __( 'Select page','woocommerce-my-account-widget' ) ); ?>
                </option> 
                <?php 
                    $pages = get_pages(); 
                    foreach ( $pages as $page ) {
                        $option = '<option value="' . $page->ID . '" '.selected($instance['register_page'],$page->ID,false).'>';
                        $option .= $page->post_title;
                        $option .= '</option>';
                        echo $option;
                    }
        ...
        <!-- end added by derwent --> 
        <p>
            <label for="<?php echo $this->get_field_id('wma_redirect'); ?>">
                <?php _e('Redirect to page after login:', 'woocommerce-my-account-widget') ?>
            </label>
    	...
    	<p>
            <?php _e('Other options','woocommerce-my-account-widget');?>:<br>
    		<input 
                type="checkbox" 
                class="checkbox" 
                id="<?php echo esc_attr( $this->get_field_id('login_with_email') ); ?>" 
                name="<?php echo esc_attr( $this->get_field_name('login_with_email') ); ?>"
                <?php checked( $login_with_email ); ?> 
            />
    ...
    function update($new_instance, $old_instance) {
        ...
        //added by derwent
        $instance['show_help_link'] = !empty($new_instance['show_help_link']) ? 1 : 0;
        $instance['help_page'] = esc_attr($new_instance['help_page']);
        $instance['help_title'] = strip_tags(stripslashes($new_instance['help_title']));
        $instance['show_lost_pwd_link'] = !empty($new_instance['show_lost_pwd_link']) ? 1 : 0;
        $instance['show_register_link'] = !empty($new_instance['show_register_link']) ? 1 : 0;
        $instance['register_page'] = esc_attr($new_instance['register_page']);
    ...
    function widget($args, $instance) {	
    	...
    	if ( is_user_logged_in() ) {
            ...
            //added by derwent
            $shl = (isset($instance['show_help_link']) && $instance['show_help_link']) ? '1' : '0';
            $slp = (isset($instance['show_lost_pwd_link']) && $instance['show_lost_pwd_link']) ? '1' : '0';
            $sre = (isset($instance['show_register_link']) && $instance['show_register_link']) ? '1' : '0';
            $ucr = get_option('users_can_register');
    		...
    		if(isset($_GET['login']) && $_GET['login']=='failed') {
    			...
    			_e('Login failed, please try again. Please click account help if you cannot log in.','woocommerce-my-account-widget');
    			echo '</p>';
    		}
    		// login form
    		$args = array(
    			...
    			'label_username' => '#fa-user#',
    			'label_password' => '#fa-key#',
            ...
            // echo "<pre>".esc_attr($form)."</pre>";

            if(get_option('wma_login_with_email')=='on') {
                $username_placeholder = __('Username or email','woocommerce-my-account-widget' );
            } else {
                $username_placeholder = __('Username','woocommerce-my-account-widget' );
            } 
            $password_placeholder = __('password','woocommerce-my-account-widget' );

            $replacements = array(
                // array('/input/', 'output')
                array( '/<input type="text" ([^>]*)\/>/', '<input type="text" $1 placeholder="'. $username_placeholder .'" />' ),
                array( '/<input type="password" ([^>]*)\/>/', '<input type="password" $1 placeholder="'. $password_placeholder .'" />'),
                array( '/#fa-user#/', '<i class="fa fa-user"></i>'),
                array( '/#fa-key#/', '<i class="fa fa-key"></i>')
            );

            foreach ($replacements as $replacement) {
                // echo "replacing ". $replacement[0] ." with ". $replacement[1]."<br/>";
                $form = preg_replace($replacement[0], $replacement[1], $form);
            }

            // $form = preg_replace(
            //     '<input\s*(type="password"[^\>]*)/>', 
            //     'input $1 placeholder="'. $password_placeholder .'" ', 
            //     preg_replace(
            //         '<input\s*(type="text"[^\>]*)/>', 
            //         'input $1 placeholder="'. $username_placeholder .'" ', 
            //         $form
            //     )
            // );
            // echo "<pre>".esc_attr($form)."</pre>";
            ...
            if($slp){
                $lost_pwd_link = wp_lostpassword_url();
                $lost_pwd_title = __('Lost password?', 'woocommerce-my-account-widget');
                $links[] = '<a class="woo-ma-link woo-ma-lost-pass" href="'. $lost_pwd_link .'">'. $lost_pwd_title .'</a>';
            }

            if($sre){
                $register_link = get_permalink( $instance['register_page']);
                $register_title = __('Register', 'woocommerce-my-account-widget');
                $links[] = '<a class="woo-ma-link woo-ma-lost-pass" href="'. $register_link .'">'. $register_title .'</a>';
            }

            if($ucr) {  
                $register_link = wp_registration_url();
                // $my_account_link = get_permalink( get_option('woocommerce_myaccount_page_id') );
                $links[] = ' <a class="woo-ma-button woo-ma-register-link register-link" href="'.$register_link.'" title="'. __('Register','woocommerce-my-account-widget').'">'.__('Register','woocommerce-my-account-widget').'</a>';
            }
            
            if($shl) {
                $help_link = get_permalink( $instance['help_page']);
                $help_title = isset($instance['help_title'])?esc_attr($instance['help_title']):__('Help', 'woocommerce-my-account-widget');
                $links[] = ' <a class="woo-ma-link woo-mas-help-link" href="'. $help_link . '">' . $help_title . '</a>';
                // echo do_shortcode( '[button link="'.$help_link.'" bg_color="#d1aa67"]'.$help_title.'[/button]');
            }

    		if($c) {
    			$links[] = ' <a class="woo-ma-button woo-ma-cart-link cart-link" href="'.get_permalink(wma_lang_id($cart_page_id)) .'" title="'. __('View your shopping cart','woocommerce-my-account-widget').'">'.__('View your shopping cart','woocommerce-my-account-widget').'</a>';
    		}

            if(!empty($links)){
                echo "<p class='bottom-links'>";
                echo implode(" | ", $links);
                echo "</p>";
            }
